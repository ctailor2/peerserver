...
PeerServer.prototype._initializeWSS = function() {
  ...
  this._wss.on('connection', function(socket) {
    ...
    socket.send(JSON.stringify({key: key, id: id, token: token}));
...
PeerServer.prototype._initializeHTTP = function() {
  ...
  // ***Capture ws get request to prevent timeout***
  this._app.get("/peerjs/:key/:id/:token", function(req, res, next){
    var params = req.params;
    res.send({parameters: params});
    return next();
  });
